...
class CustomerOrderProcessingScreen extends StatefulWidget {
  CustomerOrderProcessingScreen({Key key}) : super(key: key);

  @override
  _CustomerOrderProcessingScreenState createState() => _CustomerOrderProcessingScreenState();
}

class _CustomerOrderProcessingScreenState extends State<CustomerOrderProcessingScreen> {
   ...
   _getOrderList() async {
    ...
    try {
      ...
      for (var item in data) {
          ...
          if (_result.statusCode == 200 && item['processed'] == false) {
